  ...
  describe "#add_entry" do
   ...
   describe "#remove_entry" do
     it "removes a single entry" do
       ...
       #come back to this test and improve it
     end
   end
   ...
   describe "#import_from_entries_2.csv" do
     ...
     it "imports the 1st entry" do
       ...
       entry_one = book.entries[0]
       puts entry_one
       check_entry(entry_one, "Denise", "565-656-5656", "denise@blocmail.com")
     end
     ...
     it "imports the 2nd entry" do
       ...
       check_entry(entry_two, "Rupert", "898-989-8989", "rupert@blocmail.com")
     end
     ...
     it "imports the 3rd entry" do
       ...
       check_entry(entry_three, "Ted", "434-343-4343", "ted@blocmail.com")
     end
   end
