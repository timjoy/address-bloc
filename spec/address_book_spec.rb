  ...
  describe "#add_entry" do
   ...
   describe "#import_from_entries_2.csv" do
     ...
     it "imports the 1st entry" do
       ...
       entry_one = book.entries[0]
       check_entry(entry_one, "Ted", "434-343-4343", "ted@blocmail.com")
     end
     ...
     it "imports the 2nd entry" do
       ...
       check_entry(entry_two, "Denise", "565-656-5656", "denise@blocmail.com")
     end
     ...
     it "imports the 3rd entry" do
       ...
       check_entry(entry_three, "Rupert", "898-989-8989", "rupert@blocmail.com")
     end
   end
 end
